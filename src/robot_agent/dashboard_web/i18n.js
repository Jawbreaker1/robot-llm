((global) => {
  ...
  const sv = Object.freeze({
    ...
    "settings.microphone.language_auto": "Identifiera automatiskt",
    ...
    "microphone.status.transcript_ready": "Transkript klart",
    "microphone.status.no_speech": "Inget tal upptäcktes · prova igen eller höj känsligheten",
  ...
  const en = Object.freeze({
    ...
    "settings.microphone.language_auto": "Detect automatically",
    ...
    "microphone.status.transcript_ready": "Transcript ready",
    "microphone.status.no_speech": "No speech detected · try again or raise the sensitivity",
