((global) => {
  ...
  const sv = Object.freeze({
    ...
    "chat.poll_failed": "Turn-polling misslyckades.",
    "chat.poll_unrecoverable": "Turnstatus kunde inte återhämtas. Starta en ny konversation eller ladda om sidan.",
  ...
  const en = Object.freeze({
    ...
    "chat.poll_failed": "Turn polling failed.",
    "chat.poll_unrecoverable": "Turn status could not be recovered. Start a new conversation or reload the page.",
