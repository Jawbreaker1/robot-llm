((global) => {
  ...
  const sv = Object.freeze({
    ...
    "session.expired.title": "Den här dashboard-sessionen har avslutats.",
    "session.expired.body": "Öppna den nya sessionslänken som visas i terminalen.",
    ...
    "mission.history.title": "Senaste episodens tidslinje",
    ...
    "mission.timeline.empty": "Ingen episodaktivitet ännu.",
    ...
    "workbench.welcome.body": "Jag kör lokalt på din Mac. Välj Arbetsbänk för samtal eller Robot för att ge EV3RSTORM ett autonomt mål.",
    ...
    "robot.control.eyebrow": "Fysisk episod",
  ...
  const en = Object.freeze({
    ...
    "session.expired.title": "This dashboard session has ended.",
    "session.expired.body": "Open the new session link shown in the terminal.",
    ...
    "mission.history.title": "Latest episode timeline",
    ...
    "mission.timeline.empty": "No episode activity yet.",
    ...
    "workbench.welcome.body": "I run locally on your Mac. Choose Workbench for conversation or Robot to give EV3RSTORM an autonomous goal.",
    ...
    "robot.control.eyebrow": "Physical episode",
