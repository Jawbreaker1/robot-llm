((global) => {
  ...
  const sv = Object.freeze({
    ...
    "mission.details.description": "Följ beslut, handlingar, perception och tal i samma ordning som de inträffar.",
    "mission.details.title": "Plan och händelsehistorik",
  ...
  const en = Object.freeze({
    ...
    "mission.details.description": "Follow decisions, actions, perception, and speech in the order they happen.",
    "mission.details.title": "Plan and event history",
