((global) => {
  ...
  const sv = Object.freeze({
    ...
    "map.canvas.svg_description": "Rutnät med robotpose, beläggningsceller, färska sensorstrålar och objekthypoteser när sådana fakta finns.",
    ...
    "workbench.target.label": "Mottagare",
    "workbench.target.robot": "Roboten · autonomt mål",
    "workbench.target.workbench": "Arbetsbänken · samtal",
  ...
  const en = Object.freeze({
    ...
    "map.canvas.svg_description": "A grid with robot pose, occupancy cells, fresh sensor rays, and object hypotheses when those facts are available.",
    ...
    "workbench.target.label": "Target",
    "workbench.target.robot": "Robot · autonomous goal",
    "workbench.target.workbench": "Workbench · conversation",
